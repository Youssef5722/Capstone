...
<head>
    ...
    <title>Reset Your Password — CMS</title>
    <style>
        ...
        .header { background: linear-gradient(135deg, #7a22fd 0%, #0affff 100%); padding: 36px 40px; text-align: center; }
        ...
        .btn { display: inline-block; background: linear-gradient(135deg, #7a22fd, #0affff); color: #fff; text-decoration: none; padding: 14px 36px; border-radius: 50px; font-size: 15px; font-weight: 600; letter-spacing: 0.3px; }
