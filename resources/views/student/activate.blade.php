...
@section('title', __('cms.auth.activate_btn') . ' — CMS')
    ...
    <div class="auth-form-container">
        <div class="auth-card large" id="studentAuthCard">
            ...
            <div class="auth-card-header">
                <h2 class="auth-card-title register-title student" id="cardTitle"><i class="bi bi-circle-fill" style="font-size:8px;vertical-align:middle;"></i> {{ strtoupper(__('cms.auth.stu_reg_title')) }}</h2>
            ...
            <div class="auth-tabs">
                <a href="{{ route('student.login') }}" class="auth-tab" data-panel="panelLogin">{{ __('cms.auth.tab_login') }}</a>
                <a href="{{ route('student.activate') }}" class="auth-tab active student-theme" data-panel="panelActivate">{{ __('cms.auth.tab_signup') }}</a>
            </div>
            ...
            <div class="form-panels-wrapper" id="formPanelsWrapper">
                ...
                <!-- PANEL: ACTIVATE (Visible) -->
                <div class="form-panel panel-visible" id="panelActivate"
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('student.activate.submit') }}" novalidate id="activateForm">
                        @csrf

                        {{-- Row 1: Activation Code + Email (self-registration) --}}
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 position-relative">
                                <label class="form-label" for="actEmail">{{ __('cms.auth.register_email_label') }}</label>
                                <div class="input-icon-wrapper">
                                ...
                                @error('email')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @else
                                    <div class="invalid-feedback">{{ __('cms.auth.register_email_label') }}</div>
                                @enderror
                            </div>
                        </div>
